...
tests/fm-crew-model.test.sh               # Claude crew-model resolution, usage, and spawn template wiring tests
...
tests/fm-teardown-herdr.test.sh           # Herdr-native teardown removes the linked worktree and still closes the Herdr tab/process explicitly
